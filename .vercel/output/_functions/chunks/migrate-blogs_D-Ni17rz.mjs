...
import { ax as generateCspDigest, b7 as unescapeHTML, Q as renderTemplate, ba as removeBase, aY as isRemotePath, A as AstroError, bb as UnknownContentCollectionError } from './sequence_Cf8J0QyC.mjs';
import { s as spreadAttributes } from './entrypoint_CnFHr9Fc.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BoouZlyy.mjs');
